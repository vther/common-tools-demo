...
public class JDK8TimeMain {
    public static void main(String[] args) {
        ...
        */
        ...
        /* LocalDate 本地日期
        LocalDate 表示了一个确切的日期，比如 2014 - 03 - 11。该对象值是不可变的，用起来和LocalTime基本一致。下面的例子展示了如何给Date对象加减天 / 月 / 年。另外要注意的是这些对象是不可变的，
        操作返回的总是一个新实例。
        复制代码 代码如下:*/
        ...
        DateTimeFormatter germanFormatterMEDIUM =
                DateTimeFormatter
                        .ofLocalizedDate(FormatStyle.MEDIUM)
                        .withLocale(Locale.GERMAN);
        LocalDate xmas = LocalDate.parse("24.12.2014", germanFormatterMEDIUM);
        ...
        */
        ...
        System.out.println(string);     // Nov 03, 2014 - 07:13
         ...
         /*     和java.text.NumberFormat不一样的是新版的DateTimeFormatter是不可变的，所以它是线程安全的。
            关于时间日期格式的详细信息：http:*/
        //download.java.net/jdk8/docs/api/java/time/format/DateTimeFormatter.html
    }
}
